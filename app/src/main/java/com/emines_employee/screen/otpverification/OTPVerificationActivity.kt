...
import com.emines_employee.databinding.ActivityOtpverificationBinding
...
class OTPVerificationActivity : BaseActivity() {
    ...
    private val verifyDataObserver:Observer<ApiResponse<BaseResponse<UserResponse>>>by lazy {
        Observer {
            when(it.status){
                ...
                ApiResponse.Status.SUCCESS->{
                    ...
                    CustomDialogs.showLoginSuccessDialog(this@OTPVerificationActivity, object :
                        ...
                        override fun onComplete(d: Dialog) {
                            countDownTimer.onFinish()
                            d.dismiss()
                            launchActivity(VerifyMeActivity::class.java)
                            finish()
                        }
                    }).show()
                }
    ...
    private fun setOtpTimer() {
        countDownTimer = object : CountDownTimer(60000, 1000) {
            override fun onTick(p0: Long) {
                ...
                oBinding.tvOTPTime.setTextColor(ResourcesCompat.getColor(resources, R.color.black, null))
            ...
            override fun onFinish() {
                ...
                oBinding.tvOTPTime.setTextColor(ResourcesCompat.getColor(resources, R.color.hint_text_color, null))
