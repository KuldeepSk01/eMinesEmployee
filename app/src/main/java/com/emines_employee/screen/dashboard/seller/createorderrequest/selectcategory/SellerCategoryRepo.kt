...
class SellerCategoryRepo : BaseRepository() {
    ...
    fun executeSellerOrderRequestApi(
        req: SellerOrderRequest,
        responseLiveData: MutableLiveData<ApiResponse<SuccessMsgResponse>>
    ) {
        val call = apiService.sellerOrderRequest(req)
        responseLiveData.value = ApiResponse.loading()
    ...
    fun executeSellerAddressListApi(
        ...
        val call = apiService.sellerAddressList(sellerId)
        responseLiveData.value = ApiResponse.loading()
