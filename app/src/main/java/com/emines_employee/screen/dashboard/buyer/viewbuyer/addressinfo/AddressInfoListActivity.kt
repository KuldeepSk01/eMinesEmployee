...
class AddressInfoListActivity : BaseActivity(), AdapterBuyerAddressListener {
    ...
    override fun onResume() {
        ...
        mViewModel.getBuyerAddressListResponse()
            .observe(this@AddressInfoListActivity, addressResponseObserver)
        ...
        if (buyerAddressList.isEmpty()) {
            ...
            mBind.rvSelectAddress.apply {
                layoutManager = LinearLayoutManager(
                    this@AddressInfoListActivity, LinearLayoutManager.VERTICAL, false
                )
                adapter = BuyerAddressAdapter(
                    buyerAddressList, this@AddressInfoListActivity, this@AddressInfoListActivity
                )
            }
        }
