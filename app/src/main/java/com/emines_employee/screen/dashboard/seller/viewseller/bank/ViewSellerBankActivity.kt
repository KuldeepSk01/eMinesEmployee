package com.emines_employee.screen.dashboard.seller.viewseller.bank
...
class ViewSellerBankActivity : BaseActivity() {
    ...
    override fun onCreateInit(binding: ViewDataBinding?) {
        ...
        mBind.apply {
            toolbarBuyer.tvToolBarTitle2.text = String.format("%s %s",getString(R.string.bank_account),"(${getString(R.string.seller)})")
