...
class AddSellerAddressActivity : BaseActivity() {

    private val mViewModel: SellerAddressViewModel by inject()
    ...
    override fun onCreateInit(binding: ViewDataBinding?) {
        ...
        val sellerDetail = intent.getBundleExtra(Constants.DefaultConstant.BUNDLE_KEY)
            ...
            etAInfoTypeState.setOnClickListener {
                if (stateList.isEmpty()) {
                    ...
                    mViewModel.getStateListResponse()
                        .observe(this@AddSellerAddressActivity, stateListObserver)
                } else {
                ...
                tvSecondBtn.apply {
                    ...
                    setOnClickListener {
                        if (etAInfoTypeState.text.toString().isEmpty()) {
                            ...
                            val req = SellerAddressRequest().apply {
                            ...
                            mViewModel.hitAddSellerAddressApi(req)
                            mViewModel.getAddSellerAddressResponse()
                                .observe(this@AddSellerAddressActivity, saveAddressObserver)
                        }
                    }
    ...
    private fun popupDialog(list: List<BuyerAddressStateResponse>) {
        val alertDialog = Dialog(this@AddSellerAddressActivity)
        val b = DataBindingUtil.inflate<DailogCustomTextListBinding>(
            LayoutInflater.from(this@AddSellerAddressActivity),
        ...
        b.rvCustomList.apply {
            ...
            adapter = CustomTextPickerAdapter(list as MutableList<BuyerAddressStateResponse>,
                this@AddSellerAddressActivity, object : CustomTextPickerAdapter.OnStatePickerListener {
