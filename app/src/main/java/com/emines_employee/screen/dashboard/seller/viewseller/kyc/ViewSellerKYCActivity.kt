package com.emines_employee.screen.dashboard.seller.viewseller.kyc
...
import com.emines_employee.screen.dashboard.seller.viewseller.bank.ViewSellerBankActivity
...
class ViewSellerKYCActivity : BaseActivity() {
                ...
                bottomButtons.apply {
                    ...
                    tvSecondBtn.apply {
                        ...
                        setOnClickListener {
                            ...
                            launchActivity(
                                ViewSellerBankActivity::class.java,
