...
class BuyersAddressViewModel(private val repo: BuyersAddressRepo) : BaseViewModel() {
    ...
    fun hitAddBuyerAddressApi(req: BuyerAddressRequest) {
        repo.executeAddBuyerAddressApi(req, addBuyerAddressResponse)
    }

    fun getAddBuyerAddressResponse(): MutableLiveData<ApiResponse<SuccessMsgResponse>> {
