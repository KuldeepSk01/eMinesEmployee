...
class VerifyMe2ViewModel(private val repo: VerifyProfileRepo) : BaseViewModel() {

    lateinit var verifyMe2Activity : VerifyMe2Activity
    var onClickPresentOne = true
    ...
    private fun hitMarkPresentApi() {
        val req = MarkPresentRepo().apply {
            ...
            isHalfDay = 0
            currentLocation = verifyMe2Activity.address
        }
        ...
        Observer {
            ...
            when (it.status) {
                ...
                ApiResponse.Status.SUCCESS -> {
                    ...
                    //verifyMe2Activity.finishAffinity()
                }
