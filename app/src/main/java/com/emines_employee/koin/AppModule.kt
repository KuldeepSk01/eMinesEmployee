...
import com.emines_employee.application.EMinesEmployeeApplication
import com.emines_employee.network.ApiService
import com.emines_employee.network.intercepter.NetworkInterceptor
...
import com.emines_employee.util.Constants.NetworkConstant.Companion.API_TIMEOUT
import com.emines_employee.util.Constants.PreferenceConstant.Companion.PREFERENCE_NAME
import com.emines_employee.util.validation.ValidationHelper
...
val appModule = module {
    ...
    single {
        PreferenceHelper(
            (androidApplication() as EMinesEmployeeApplication).getSharedPreferences(
